  ...
  class KPlayer {
      ...
      async injectSearchActions() {
          if (!this.localConfig.showSearchActions)
              return;
          this.$searchActions = $__default['default'](searchActionsHTML);
          const actions = await runtime.getSearchActions();
          if (actions.length === 0)
              return;
          this.$searchActions.find('.k-menu').append(actions.map(({ name, search }) => {
              return $__default['default'](`<li class="k-menu-item k-speed-item">${name}</li>`).on('click', search);
          }));
...
`)
  ...
  runtime.register({
      ...
      search: {
          ...
          getSearchName: () => $__default['default']('#detailname a').text(),
      },
  });
  ...
  runtime.register({
      ...
      search: {
          name: '动漫岛',
          search: searchAction,
          getSearchName: () => $__default['default']('.play_menu a:last').text(),
  ...
  function playModule$6() {
      ...
      window.addEventListener('message', (e) => {
          ...
          if (key === 'getSearchName') {
              const iframe = $__default['default']('#playbox iframe')[0];
              iframe.contentWindow?.postMessage({ key: 'getSearchName', name: $__default['default']('.gohome.l > h1 > a').text() }, '*');
          }
          if (key === 'openLink') {
  ...
  runtime.register({
      ...
      search: {
          ...
          getSearchName: () => $__default['default']('.gohome > a:last').text(),
      },
  });
  ...
  function queryDom(selector) {
      return new Promise((resolve) => {
          let dom;
          function search() {
              dom = $__default['default'](selector);
              if (dom.length === 0) {
  ...
  runtime.register({
      ...
      search: {
          ...
          getSearchName: () => $__default['default']('.playtitle span a').text(),
      },
  });
  ...
  runtime.register({
      ...
      search: {
          ...
          getSearchName: () => $__default['default']('.video_title > .title').text(),
      },
  });
