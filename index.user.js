...
>
  <!-- Plyr.svg -->
  ${decodeURIComponent(img.replace("data:image/svg+xml,", ""))}
...
`);
  ...
  var css$7 = ".pro-ascepan-top #bkcl {\n  display: none !important;\n}";
  injectCss(css$7,{});
  ...
  var css$6 = ".agefans-wrapper .video_detail_episode a:visited {\n  color: rgb(220, 53, 69) !important;\n}";
  injectCss(css$6,{});

  var css$5 = ".k-episode-anchor:visited {\n  color: rgb(220, 53, 69) !important;\n}\n\n.k-his-table {\n  width: 100%;\n  line-height: 1.4;\n  border-spacing: 0;\n  border-collapse: separate;\n}\n.k-his-table th,\n.k-his-table td {\n  padding: 6px 8px;\n}\n.k-his-table tr {\n  transition: background 0.3s ease;\n}\n.k-his-table tr:hover {\n  background: #f1f1f1;\n}\n.k-his-table a {\n  text-decoration: none;\n  transition: color 0.15s ease;\n}\n.k-his-table a:hover {\n  color: var(--k-player-primary-color);\n}\n.k-his-table .k-btn {\n  color: var(--k-player-primary-color);\n}";
  injectCss(css$5,{});
  ...
  function defineIframePlayer(config) {
    ...
    function createHistrory() {
      if (config.history) {
        config.history.creator(renderHistroy$1);
      }
    }
    ...
    function runInTop() {
      ...
      window.addEventListener("message", async (e) => {
        ...
        (_d = config.onIframeMessage) == null ? void 0 : _d.call(config, e.data.key, e.data, e);
      });
    }
  ...
  async function mobilePlayModule() {
    await wait(() => getActive$5().length > 0);
...
<li class="one_new_anime" style="display:flex; justify-content:space-between;">
  ...
  function switchPart$2(next) {
    var _a;
    return (_a = getActive$2()[next ? "next" : "prev"]().get(0)) == null ? void 0 : _a.href;
  }
  function runInTop$2() {
  ...
  const iframePlayer$2 = defineIframePlayer({
    ...
    switchEpisode: (next) => switchPart$2(next)
  });
