...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-right:4px;" width="1em" height="1em" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
  ...
  var css$1 = ".agefans-wrapper #relates-series .relates_series {\n  display: block;\n  padding: 4px 0px;\n}";
  n(css$1,{});
...
`).insertAfter($__default['default']('.baseblock:contains(简介：)')).find('ul').append($series);
  ...
  function initEvent$2() {
    player$2.on('prev', () => window.parent.postMessage('prev', {
      targetOrigin: '*'
    }));
    player$2.on('next', () => window.parent.postMessage('next', {
      targetOrigin: '*'
    }));
  }
  ...
  function playModule$2() {
    ...
    if (location.pathname.includes('/v')) {
      window.addEventListener('message', e => {
        if (e.data === 'prev') switchPart$2(false);
        if (e.data === 'next') switchPart$2(true);
      });
    }
