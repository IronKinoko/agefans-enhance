...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-right:4px;" width="1em" height="1em" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
          ...
          async function _getUrl() {
              try {
                  ...
                  if (error instanceof AGEfansError) {
                      ...
                      $__default['default'](`<a style="cursor:pointer">加载错误，请重试</a>`)
                          .appendTo($msg)
                          .on('click', async () => {
                          // 失败需要重试获取cookie
                          await updateCookie();
  ...
  function detailModule() {
      renderHistroyStyle();
      $__default['default']('.div_left li > a:nth-child(1), .ul_li_a4 li > a:nth-child(1)').each((_, anchor) => pagePreview(anchor.parentElement, anchor.href));
  }
  ...
  function refreshHistoryList() {
      ...
      const $doms = $__default['default']('#history .history-item');
      if (list.length !== $doms.length)
          return renderHistoryList();
      list.forEach((item) => {
          const $dom = $__default['default'](`#history a[data-id='${item.id}']`);
  ...
  function renderHistoryPage() {
      ...
      const $hisNavBtn = $__default['default'](`<a class="nav_button">历史</a>`)
      ...
      $__default['default']('.nav_button_current')
          .on('click', (e) => {
          $__default['default']('#container').show();
          $__default['default']('#history').hide();
          stopRefresh();
  ...
  function homeModule() {
      $__default['default']('#container li > a:nth-child(1)').each((_, anchor) => pagePreview(anchor.parentElement, anchor.href));
      $__default['default']('#new_anime_btns li').on('click', () => {
          $__default['default']('#new_anime_page > li > a.one_new_anime_name').each((_, anchor) => pagePreview(anchor.parentElement, anchor.href));
      });
  }
  ...
  class Message {
      ...
      info(message, duration = 1500) {
          ...
          return new Promise((resolve) => {
              $__default['default'](`<div class="k-player-message-item"></div>`)
                  .append(message)
                  .hide()
...
`;
  ...
  class KPlayer {
      ...
      constructor(selector, opts = {}) {
          ...
          const $video = (opts.video ? $__default['default'](opts.video) : $__default['default']('<video />')).attr('id', 'k-player');
      ...
      injectQuestion() {
          $__default['default'](`<svg class="k-player-question-icon"><use xlink:href="#question"/></svg>`)
      ...
      injectNext() {
          $__default['default']($__default['default']('#plyr__next').html())
      ...
      injectSnapshot() {
          ...
          $__default['default']($__default['default']('#plyr__snapshot').html())
      ...
      injectSreen() {
          $__default['default']($__default['default']('#plyr__widescreen').html())
              .insertBefore('[data-plyr="fullscreen"]')
              .on('click', () => {
              this.toggleWidescreen();
          });
  ...
  function addReferrerMeta(content) {
      if ($__default['default']('meta[name=referrer]').length === 0) {
          $__default['default']('head').append(`<meta name="referrer" content="${content}">`);
      }
      else {
...
`).insertBefore($__default['default']('.baseblock:contains(网盘资源)'));
  ...
  function useOriginPlayer() {
      ...
      const $dom = $__default['default'](`<span>启用脚本</span>`)
          .css({ color: '#60b8cc', cursor: 'pointer' })
          .on('click', () => {
          session.removeItem('stop-use');
          window.location.reload();
      });
      $__default['default']('#wangpan-div .blocktitle')
...
`)
          .insertAfter($__default['default']('.baseblock:contains(简介：)'))
          .find('ul')
          .append($series);
  }
  ...
  function recommendModule() {
      $__default['default']('ul.ul_li_a6 > li > a').each((_, anchor) => pagePreview(anchor.parentElement, anchor.href));
  }
  ...
  runtime.register('88dmw', [
      { test: '/play', setup: www88dmwSetup, run: playModule$8 },
  ]);
  ...
  function switchPart$6(next) {
      ...
      if (!directionRight)
          direction.reverse();
      $__default['default']('.movurls .sel')[direction[1]]().find('a')[0]?.click();
  }
  ...
  runtime.register(['yhdmp.cc'], [{ test: '/vp', run: playModule$6 }]);
  ...
  runtime.register(['imomoe.live'], [{ test: '/player', run: playModule$5 }]);
  ...
  function switchPart$2(next) {
      $__default['default']('.active-play').parent()[next ? 'next' : 'prev']().find('a')[0]?.click();
  }
  ...
  function playModule$2() {
      window.addEventListener('message', (e) => {
          ...
          if (key === 'enterwidescreen') {
              $__default['default']('body').css('overflow', 'hidden');
              $__default['default'](iframeSelector).css({
                  position: 'fixed',
                  left: 0,
                  right: 0,
                  bottom: 0,
          ...
          if (key === 'exitwidescreen') {
              $__default['default']('body').css('overflow', '');
              $__default['default'](iframeSelector).removeAttr('style');
          }
          if (key === 'canplay') {
              const width = $__default['default']('#ageframediv').width();
              if (width)
                  $__default['default']('#ageframediv').height((video.height / video.width) * width);
          }
      });
      window.addEventListener('keydown', (e) => {
          if (document.activeElement !== document.body)
              return;
          $__default['default'](iframeSelector)[0].focus();
          if (e.key === ' ')
              e.preventDefault();
      });
  }
  ...
  function switchPart$1(next) {
      $__default['default']('.eplist-eppic li[style]')[next ? 'next' : 'prev']().find('a')[0]?.click();
  }
  ...
  function switchPart(next) {
      $__default['default'](`.play_but.bline a:contains(${next ? '下集' : '上集'})`)[0]?.click();
  }
  function playModule() {
      ...
      function toggle(bool) {
          $__default['default']('.hot_banner').toggle(bool);
          $__default['default']('#play_page > div.foot.foot_nav.clearfix').toggle(bool);
      }
      ...
      $__default['default']('#play_page > div.hidden_xs.hidden_mi.pannel.clearfix').remove();
  }
